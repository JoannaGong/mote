...
class _SetUpState extends State<SetUp> with AutomaticKeepAliveClientMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text('个人信息', style: TextStyle(color: Color(0xFF333333)),), centerTitle: true, backgroundColor: Color(0xFFFFFFFF), elevation: 0, iconTheme: IconThemeData(color: Colors.black),),
      body: Container(
