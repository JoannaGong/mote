...
@RoutePage()
class MerchantPerson extends StatelessWidget {
  @override
        ...
        Container(
          ...
          child: Column(children: <Widget>[
            Container(
              ...
              child:Align(alignment: Alignment.centerLeft, child: Text('真实姓名', style: TextStyle(fontSize: ScreenUtil().setSp(32))))
            ),
            TextFormField(
            ...
            Container(
              padding: EdgeInsets.only(top: ScreenUtil().setHeight(32)),
              child:Align(alignment: Alignment.centerLeft, child: Text('身份证号', style: TextStyle(fontSize: ScreenUtil().setSp(32))))
            ),
            TextFormField(
              decoration: InputDecoration(
                labelText: '请填写',
          ...
          child: Column(children: <Widget>[
            ...
            Container(
              ...
              child: RaisedButton(
                ...
                elevation: 0,
                child: Text('提交认证信息', style: TextStyle(fontSize: ScreenUtil().setSp(34), color: Colors.white),),
                onPressed: () {
                  Application.router.navigateTo(context, "/certificationOk", transition: TransitionType.inFromRight);
                }
              )
            )
          ])
